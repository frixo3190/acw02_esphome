...
void Tuya::handle_char_(uint8_t c) {
  // Fix: absorb duplicate 0x55 sent by some MCUs (e.g. Airton 409966)
  // These devices send 55 55 AA instead of 55 AA as frame header
  if (c == 0x55 && this->rx_message_.size() == 1 && this->rx_message_[0] == 0x55)
    return;
